  ...
  return (
    <div className="w-1/2 flex justify-center">
      <div className="min-w-[415px] w-full">
        <div className="font-extrabold text-8xl leading-tight tracking-wider select-none">
        ...
        <div className="w-[220px] h-[74px] border-slate-200 border-[1px] rounded-full flex items-center justify-start px-1 ">
